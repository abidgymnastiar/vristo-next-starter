                    ...
                    <PerfectScrollbar className="relative h-[calc(100vh-80px)]">
                        <ul className="relative space-y-0.5 p-4 py-0 font-semibold">
                            ...
                            <li className="nav-item">
                                <ul>
                                    <li className="menu nav-item">
                                        <button type="button" className={`${currentMenu === 'dataproduk' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('dataproduk')}>
                                            <div className="flex items-center">
                                                <IconMenuDocumentation className="shrink-0 group-hover:!text-primary" />
                                                <span className="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">{t('dataproduk')}</span>
                                            </div>

                                            <div className={currentMenu !== 'dataproduk' ? '-rotate-90 rtl:rotate-90' : ''}>
                                                <IconCaretDown />
                                            </div>
                                        </button>

                                        <AnimateHeight duration={300} height={currentMenu === 'dataproduk' ? 'auto' : 0}>
                                            <ul className="sub-menu text-gray-500">
                                                <li>
                                                    <Link href="/dataproduk/list">{t('list')}</Link>
                                                </li>
                                                <li>
                                                    <Link href="/apps/dataproduk/preview">{t('preview')}</Link>
                                                </li>
                                                <li>
